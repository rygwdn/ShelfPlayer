...
public final class AppSettings: @unchecked Sendable {
    ...
    public var audioGain: Double = 1.0 {
        didSet { suite.set(audioGain, forKey: "audioGain") }
    }

    public var audioGainAdjustment: Double = 0.05 {
        didSet { suite.set(audioGainAdjustment, forKey: "audioGainAdjustment") }
    }

    public var audioVocalBoost: Double = 0.0 {
        didSet { suite.set(audioVocalBoost, forKey: "audioVocalBoost") }
    }

    public var audioVocalBoostAdjustment: Double = 1.0 {
        didSet { suite.set(audioVocalBoostAdjustment, forKey: "audioVocalBoostAdjustment") }
    }
    ...
    private init() {
        ...
        audioGain = suite.object(forKey: "audioGain") as? Double ?? 1.0
        audioGainAdjustment = suite.object(forKey: "audioGainAdjustment") as? Double ?? 0.05
        audioVocalBoost = suite.object(forKey: "audioVocalBoost") as? Double ?? 0.0
        audioVocalBoostAdjustment = suite.object(forKey: "audioVocalBoostAdjustment") as? Double ?? 1.0
