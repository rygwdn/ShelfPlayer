...
public final actor AudioPlayer: Sendable {
    public final class EventSource: @unchecked Sendable {
        ...
        public let gainChanged = PassthroughSubject<Percentage, Never>()
        public let vocalBoostChanged = PassthroughSubject<Percentage, Never>()
...
public extension AudioPlayer {
    ...
    var gain: Percentage {
        get async {
            await current?.gain ?? AppSettings.shared.audioGain
        }
    }
    var vocalBoost: Percentage {
        get async {
            await current?.vocalBoost ?? AppSettings.shared.audioVocalBoost
        }
    }
